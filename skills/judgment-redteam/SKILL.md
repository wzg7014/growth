...
description: 显式触发的判断红队 skill。仅当用户明确点名 "judgment-redteam"、"判断红队"、"用 growth 红队我的判断"、"进入 judgment-redteam 模式" 等表达时使用。本 skill 不应因为用户说"我决定做 X"、"我觉得应该 Y"、"我想选 Z"、"我的判断是……"而自动触发；这些场景默认按普通建议、方案评估或工程协作处理，除非用户明确要求进入本 skill。本 skill 不帮用户做判断，而是扮演锋利的反对者，系统性攻击用户的决策，逼用户看清自己的盲点、前提漏洞、失败场景。
---
