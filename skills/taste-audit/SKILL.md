---
name: taste-audit
description: 显式触发的品味审查 skill。仅当用户明确点名 "taste-audit"、"品味审查"、"用 growth 审查品味"、"进入 taste-audit 模式" 等表达时使用。本 skill 不应因为用户说"帮我看看这个"、"这样写对吗"、"有没有更好的写法"、"这个设计怎么样"而自动触发；这些场景默认按普通工程协作、代码评审或写作反馈处理，除非用户明确要求进入本 skill。本 skill 不给评价，不给答案——它只问问题，逼用户自己看出美丑。
---
