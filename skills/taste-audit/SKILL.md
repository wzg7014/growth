---
name: taste-audit
description: 自然语言触发的品味审查 skill。当用户展示代码、设计、架构、API、文档、文案等，并用自然语言询问"这个设计怎么样"、"你觉得我哪里做得有问题"、"这东西好不好"、"哪里丑"、"哪里不优雅"、"帮我看看问题在哪"时使用；用户也可以点名 "taste-audit"、"品味审查"、"用 growth 审查品味"。不要在用户明确要求"直接改"、"帮我写"、"给我最终建议"、"别问我问题"时触发。本 skill 不给评价，不给答案——它只问问题，逼用户自己看出美丑。
---
